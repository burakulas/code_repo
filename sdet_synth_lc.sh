...
mv lc_p_${pern}_m_${mod}_i_${i}_ec_${ec}_${qn}_${t1n}_${t2n}_${pot1n}_${pot2n}.dat ../lcplay/sd_lc/
...
done < sd_parameters.lst # to access the list: https://drive.google.com/file/d/1NpUY1VI1H4m0eMNiqeMadBFpJamqkpAv/view?usp=sharing
